...
st.markdown(
    ...
    .card-lookup::before   { background: #a78bfa; }
    ...
    .tag-lookup  { background: rgba(167,139,250,0.15); color: #a78bfa;  border: 1px solid #a78bfa44; }
...
st.markdown(
    ...
    <div class="card-grid-2">
      ...
      <div class="dash-card card-pm25">
        ...
        <div class="card-desc">
          Visualise fine-particulate-matter (PM2.5) trends from NASA models
          using satellite data on an interactive world map. Identify pollution
          hotspots and examine long-term air quality trajectories by region.
        </div>
        <div class="card-chips">
          <span class="chip">PM2.5</span>
    ...
    <div class="card-grid-2">
      ...
      <div class="dash-card card-ftemp">
        ...
        <div class="card-desc">
          ...
          moderate and high emission scenarios. Difference maps highlight
          regions facing accelerated warming under the higher-emission pathway.
        </div>
        <div class="card-chips">
...
# ═══════════════════════════════════════════════════════════════════════════════
# Row 4 — Country Lookup (single full-width card)
# ═══════════════════════════════════════════════════════════════════════════════
st.markdown('<hr class="divider">', unsafe_allow_html=True)
st.markdown('<div class="section-label">🌐 Country-Level Deep Dive</div>', unsafe_allow_html=True)

st.markdown(
    """
    <div class="card-grid-2">

      <div class="dash-card card-lookup">
        <span class="card-icon">🌐</span>
        <span class="card-tag tag-lookup">Country Lookup</span>
        <div class="card-title">Country Lookup</div>
        <div class="card-desc">
          Search any country by name, abbreviation, or alias to instantly
          retrieve all eight environmental stress indices alongside its HDI
          score. Includes observed trends, CMIP6 projections, deviation charts,
          and a downloadable summary table.
        </div>
        <div class="card-chips">
          <span class="chip">Free-text search</span>
          <span class="chip">All 8 indices</span>
          <span class="chip">vs Global mean</span>
...
with col_btn:
    if st.button("↗ Open Country Lookup", use_container_width=True, type="primary"):
        st.switch_page("pages/8_Country_Lookup.py")
